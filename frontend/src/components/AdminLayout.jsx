  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="lg:hidden bg-blue-950 text-white p-4">
        <h1 className="text-xl font-bold">IGSA Portal</h1>
        <p className="text-xs text-blue-200">Board Dashboard</p>
        ...
        <div className="flex gap-3 mt-3">
          ...
          <Link
            to="/"
            className="bg-white text-blue-950 px-4 py-2 rounded-xl text-sm font-bold"
          >
            Website
          </Link>
        </div>
      ...
      <main className="lg:ml-72 min-w-0 max-w-[calc(100vw-18rem)] lg:max-w-[calc(100vw-18rem)] p-4 md:p-8 overflow-x-hidden">
